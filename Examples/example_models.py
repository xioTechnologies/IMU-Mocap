...
class Model(ABC):
    def __init__(self) -> None:
        ...
        self.__joints = {
            ...
            # Torso
            "Upper Torso": Joint(self.upper_torso, Matrix.align_py_nx_pz()),
            "Lower Torso": Joint(self.lower_torso, Matrix.align_py_nx_pz()),
            "Upper Lumbar": Joint(self.upper_lumbar, Matrix.align_py_nx_pz()),
            "Lower Lumbar": Joint(self.lower_lumbar, Matrix.align_py_nx_pz()),
            # Left leg
