...
save_as_button = ttk.Button(button_bar, text="Save as", command=on_save_as)
...
reset_button = ttk.Button(button_bar, text="Reset", command=on_reset)
...
symmetry_checkbox = ttk.Checkbutton(button_bar, text="Symmetry", variable=symmetry_var, command=on_symmetry_toggle)
...
total_required_height = button_bar.winfo_reqheight() + grid_frame.winfo_reqheight() + padding
...
def update_model_loop():
    # symmetry update
    if symmetry_var.get() and active_slider:
