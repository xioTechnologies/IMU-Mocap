...
# Load model
model = imumocap.file.load_model(initial_path) # models.Factory().upper_body_special() # 

original_pose = model.get_pose()
...
def on_save():
    ...
    try:
        imumocap.file.save_model(save_file_path, model)
        print("Saved")
...
def on_save_as():
    ...
    try:
        ...
        if file_path:
            ...
            imumocap.file.save_model(file_path, model)
