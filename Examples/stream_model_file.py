...
while True:
    ...
    if any([i.button_pressed for i in imus.values()]):
        ...
        heading = imumocap.solvers.calibrate(root, {n: i.matrix for n, i in imus.items()}, calibration_pose, Mounting.Z_FORWARDS)

        print("Calibrated")

    imumocap.set_pose_from_imus(root, {n: i.matrix for n, i in imus.items()}, heading)
