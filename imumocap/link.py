...
class Link:
    def __init__(self, name: str, end: Matrix, wheel_axis: Matrix | None = None) -> None:
        ...
        self.__links: list[tuple[Link, Matrix]] = []  # [(<next link>, <matrix>), ...] where matrix is the origin of the next link relative to the end of this link
        self.__is_root = True
